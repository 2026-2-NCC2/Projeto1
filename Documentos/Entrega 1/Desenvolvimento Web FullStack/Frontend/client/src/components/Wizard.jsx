// nome de cada etapa que aparece embaixo das bolinhas
const labels = ['Evento', 'Público e lotes', 'Custos', 'Resumo'];

// barra de etapas do formulario de criar evento (1 --- 2 --- 3 --- 4)
// currentStep = etapa atual / onStepClick = o que fazer ao clicar numa bolinha
      ...
      {labels.map((label, index) => {
        ...
        return (
          <div className="relative flex flex-col items-center gap-2" key={label}>
            {/* bolinha: feita fica dourada com ✓, a atual ganha um anel em volta, as proximas ficam cinza */}
            ...
            {/* linha ate a proxima bolinha (menos na ultima), fica dourada quando a etapa ja foi feita */}
